...
const BASE_USER_MENU: MenuConfig = [
  ...
  },
  {
    ...
    requirePermission: false,
    children: [
      { title: 'Merchant Turnover', path: '/reports/merchant-turnover', submodule: 'Reports' },
      { title: 'Merchant Transaction', path: '/reports/merchant-transaction', submodule: 'Reports' },
      ...
      { title: 'Merchant Transaction Response', path: '/reports/merchant-transaction-response', submodule: 'Reports' },
